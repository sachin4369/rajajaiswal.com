...
import { fetchLoungeChairs } from '@/lib/api';
import { Product } from '@/types';

export default function LoungeChairsSubcategoryPage() {
  ...
  useEffect(() => {
    async function loadProducts() {
      ...
      setError(null);
      try {
        const fetchedProducts = await fetchLoungeChairs();
        console.log(`Lounge Chairs loaded: ${fetchedProducts.length}`);
        ...
        console.error('Error loading lounge chairs:', error);
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <nav>
              <ol className="flex items-center space-x-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                ...
                <li>/</li>
                <li className="font-medium text-gray-900 dark:text-gray-100">Public Waiting Lounge Seater</li>
              </ol>
            </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-2xl">
              Relaxed, comfortable lounge seating options for breakout and waiting areas.
            </p>
          </div>
          {loading ? (
              ...
              {viewMode === 'grid' ? (
                ...
                <div className="space-y-3">
                  {filteredProducts.map((product, index) => (
                    ...
                    >
                      <Link href={`/products/lounge/${product.id}`}>
