...
import { fetchSchoolDeskInstituteWritingChair } from '@/lib/api';
import { Product } from '@/types';

export default function SchoolDeskInstituteWritingChairSubcategoryPage() {
  ...
  useEffect(() => {
    async function loadProducts() {
      ...
      setError(null);
      try {
        const fetchedProducts = await fetchSchoolDeskInstituteWritingChair();
        console.log(`School Desk & Institute Writing Chair loaded: ${fetchedProducts.length}`);
        ...
        console.error('Error loading school desk & institute writing chair:', error);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      {/* Compact Header for Subcategory */}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <nav>
              <ol className="flex items-center space-x-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                ...
                <li>/</li>
                <li className="font-medium text-gray-900 dark:text-gray-100">School Desk & Institute Writing Chair</li>
              </ol>
            </nav>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Heading, Count, Description, and Search */}
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              <div className="flex items-center gap-4 flex-wrap">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">
                  School Desk & Institute Writing Chair
                </h1>
                {!loading && (
            ...
            <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-2xl">
              Ergonomic seating solutions for educational institutions and schools.
            </p>
          </div>
          {loading ? (
              ...
              {viewMode === 'grid' ? (
                ...
                <div className="space-y-3">
                  {filteredProducts.map((product, index) => (
                    ...
                    >
                      <Link href={`/products/school-desk/${product.id}`}>
