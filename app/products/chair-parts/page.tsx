...
const subcategories = [
  ...
  },
  {
    ...
    description: 'Adjustable handles for chair height control',
    slug: 'adjustable-handle',
    apiCategory: 'adjustable-handle',
  },
  {
    id: 'aremrest-pp-base',
  ...
  },
  {
    id: 'wheels',
    name: 'Wheels',
    description: 'High-quality caster wheels for office chairs',
    slug: 'wheels',
    apiCategory: 'wheels',
  },
  {
  ...
  {
    id: 'pu-moulded-chair',
    name: 'PU Moulded Chair',
    description: 'Polyurethane moulded chair components',
    slug: 'pu-moulded-chair',
    apiCategory: 'pu-moulded-chair',
  },
  {
    id: 'pu-cushions',
...
export default function ChairPartsPage() {
  return (
          ...
          >
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Essential components and parts for office chairs
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {subcategories.map((subcategory, index) => (
              <motion.div
                ...
                className="group"
              >
                <Link href={`/products/chair-parts/${subcategory.id}`}>
